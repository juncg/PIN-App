    ...
    return (
        <div className="space-y-4">
                    ...
                    {visiblePosts.map((post) => {
                        ...
                        return (
                            <PostCard
                                ...
                                onLikeChangeForParent={liked => setLikeStates(prev => ({
                                    ...prev,
                                    [post.id]: liked,
                                }))}
                                subscribedByUser={subscribeStates[post.id]}
                                onSubscribeChangeForParent={subscribed => setSubscribeStates(prev => ({
                                    ...prev,
                                    [post.id]: subscribed,
                                }))}
                            />
            ...
            {!hasMore && posts.length > 0 && posts.length < maxPosts && (
                <div className="text-center py-8 space-y-4">
                    <P className="text-muted-foreground">No hay más posts para mostrar</P>
                    {batchOffset > 0 && (
                        <button
                            onClick={() => {
                                // move to previous batch
