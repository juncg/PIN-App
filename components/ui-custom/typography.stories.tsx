import { H1, H2, H3, H4, H5DisplayBold, H5SansSemiBold, S1, S2, S2MutedLineThrough, B1, B2, B3, B4, B5 } from './typography';
...
export const AllVariants = {
  render: () => (
    <div className="space-y-4">
      ...
      <S2MutedLineThrough>Subtitle 2 Muted Line Through - Funnel Sans lg Light Grey Strikethrough</S2MutedLineThrough>
