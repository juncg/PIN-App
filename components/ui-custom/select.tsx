	...
	return (
		...
		>
			...
			<SelectPrimitive.Icon asChild>
				<KeyboardArrowLeftIcon className="text-white !h-5 !w-5 -rotate-90 !items-center transition-transform duration-300 group-data-[state=open]:rotate-90" />
