...
export function ProductCardHorizontal(product: IProduct) {
	return (
		<div className="group flex h-[140px] w-full cursor-pointer rounded-[20px] border-[2px] bg-black transition-colors hover:bg-hover">
			...
			<div className="flex flex-1 flex-col justify-between py-4 px-5">
				...
				<div className="text-xl font-bold text-white">{product.msrp}€</div>
			</div>
		</div>
	);
}
